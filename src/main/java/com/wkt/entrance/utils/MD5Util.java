...
public class MD5Util {
    ...
    private static final String LCC_SALT="LccZmj";
     ...
     * @return
     */
    public static String qdEncode(String password){
        password = password + LCC_SALT;
        return processEncode(password);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(MD5Util.encode("e10adc3949ba59abbe56e057f20f883e"));
    }
}